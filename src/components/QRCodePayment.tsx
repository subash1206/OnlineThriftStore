...
export default function QRCodePayment({ amount, orderId, onPaymentComplete }: QRCodePaymentProps) {
  const { theme } = useTheme();

  // Generate UPI payment URL
  const upiUrl = `upi://pay?pa=${UPI_ID}&pn=ThriftMonkeys&am=${amount}&cu=INR&tn=Order+Payment&tr=${orderId}`;
