...
export default function Dashboard() {
  ...
  useEffect(() => {
    ...
    // Filter products based on user type and ID
    const userProducts = user?.isAdmin 
      ? [...pendingProducts, ...featuredProducts] // Admin sees all products
      : [...pendingProducts.filter((p: any) => p.sellerId === user?.id),
         ...featuredProducts.filter((p: any) => p.sellerId === user?.id)];
    ...
    try {
      ...
      reader.onloadend = () => {
        const productData = {
          ...
          pending: !user?.isAdmin, // Admin products are automatically approved
          featured: user?.isAdmin, // Admin products are automatically featured
